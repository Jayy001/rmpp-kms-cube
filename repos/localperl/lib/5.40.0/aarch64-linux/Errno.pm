...
"aarch64\-linux-5\.15\.0\-1066\-oracle" or
	die "Errno architecture (aarch64\-linux-5\.15\.0\-1066\-oracle) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
